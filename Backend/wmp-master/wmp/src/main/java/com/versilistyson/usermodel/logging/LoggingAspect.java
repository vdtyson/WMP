package com.versilistyson.usermodel.logging;
...
{
    @Around(value = "@within(com.versilistyson.usermodel.logging.Loggable) || @annotation(com.versilistyson.usermodel.logging.Loggable)")
