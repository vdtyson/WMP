package com.versilistyson.usermodel.models;
...
public class User extends Auditable
{
    ...
    @JsonIgnoreProperties("user")
    @Column(name = "user_plants", nullable = true)
    private List<Plant> userPlants = new ArrayList<>();
    public List<Plant> getUserPlants() { return userPlants; }
    public void setUserPlants(List<Plant> userPlants) { this.userPlants = userPlants; }
